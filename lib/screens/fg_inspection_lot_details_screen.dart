...
class FGInspectionLotDetailsScreen extends StatefulWidget {
  final String inspectionLotNo;

  FGInspectionLotDetailsScreen({this.inspectionLotNo});

  @override
  State<StatefulWidget> createState() => _FGInspectionLotDetailsScreenState();
}

class _FGInspectionLotDetailsScreenState
    extends State<FGInspectionLotDetailsScreen> with EDimension {
  ...
  void initState() {
    ...
    _inspection?.fgInspectionDetails?.forEach((inspectionDetail) {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "0020 FG for ${_inspection?.materialDesc ?? ''}",
                      style: AppTextStyle.blackRubik14,
                    ),
                    SizedBox(
                      height: 16,
                    ...
                    TextFormField(
                      ...
                      onChanged: (text) {
                        ...
                        if (text.isNotEmpty) {
                          ...
                          _inspection.inspectedQuality = 0;
                          _inspection?.addToFirebase(modified: true);
                          setState(() {});
                        }
                      },
            ...
            for (int i = 0;
                i < _inspection?.fgInspectionDetails?.length ?? 0;
                i++)
              getInspectionDetailItem(i, _inspection?.fgInspectionDetails[i]),
          ],
        ),
      ),
    ));
        ...
        showDialog(
            ...
            builder: (_) {
              return DialogInspectionLot(
                  index: index,
                  inspectionList: _inspection?.fgInspectionDetails,
